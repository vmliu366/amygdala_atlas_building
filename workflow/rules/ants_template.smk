...
rule register_dseg:
    input:
        ...
        warp="results/cohort-{cohort}/iter_{iteration}/{subject}_1Warp.nii.gz",
        affine="results/cohort-{cohort}/iter_{iteration}/{subject}_0GenericAffine.mat",
        ref=lambda wc: f"results/cohort-{wc.cohort}/iter_{wc.iteration}/template_{wc.channel}.nii.gz"
    output:
        dseg="results/cohort-{cohort}/iter_{iteration}/warped_dseg/{subject}_{channel}_dseg.nii.gz",
        lut="results/cohort-{cohort}/iter_{iteration}/warped_dseg/{subject}_{channel}_LUT.txt"
    log:
        "logs/register_dseg/cohort-{cohort}/iter_{iteration}_{subject}_{channel}.log"
    shell:
        r"""
